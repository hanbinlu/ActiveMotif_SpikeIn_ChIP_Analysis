...
fastq_folder = "/Extension_HDD2/Hanbin/ProjectW/200410_HL01_ChIP/HL01_raw_fastq/";
out_dir = ""
fastq = Dict{String,String}(
    "M2_1G5_0hr" => "041020Idx5_S5_L003_R1_001.fastq.gz",
    "M2_1G5_16hr" => "041020Idx6_S6_L003_R1_001.fastq.gz",
)
n, samples = length(fastq), ["M2_1G5_0hr", "M2_1G5_16hr"]
samples = [isempty(out_dir) ? s : joinpath(out_dir, s) for s in samples]
#+
